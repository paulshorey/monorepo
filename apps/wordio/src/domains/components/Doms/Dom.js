...
import IconFrown from "src/domains/components/IconFrown";
...
class Dom extends React.Component {
  ...
  render() {
    let { domain_availability_queue, domain_availability, input_tld, input_str, input_spellchecked, phraseString, io_actions } = this.props;
    ...
    if (this.state.isIntersecting && !domain_availability_queue[phraseStringNoSpaces] && !domain_availability[phraseStringNoSpaces]) {
    ...
    // premium unknown
      ...
      Icon = [<FA key={1} icon={faDollarSign} className="faDoubleDollarSign" />, <FA key={2} icon={faDollarSign} className="faDoubleDollarSign" />];
