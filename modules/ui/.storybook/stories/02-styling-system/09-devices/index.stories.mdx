...
<Code ss="font-size:0.85em;" code={`import WithDevice from '@techytools/ui/hooks/WithDevice';  
<p> 
...
import { returnDeviceInfo, deviceInfoType } from '@techytools/ui/hooks/useDeviceInfo';
