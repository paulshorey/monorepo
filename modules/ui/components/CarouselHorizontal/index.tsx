...
import CarouselHorizontal from './script';
...
export const Component = (props: Props, ref: any) => {
  ...
  useEffect(() => {
    const carousel = new CarouselHorizontal(carouselRef.current);
    return () => {
      carousel.end();
    };
  }, []);
...
/*
 * (1) default export is normal component ready to use (2) withCarouselHorizontal is HOC used to predefine common props
 */
...
export const withCarouselHorizontal = (props: Props) =>
